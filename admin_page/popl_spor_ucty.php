...
<?php 
  ...
  echo "<INPUT type='submit' name='oprava_popl' value='Provést změny v poplatcích'>
   <INPUT type='submit' name='s_popl_karty' value='Spravovat poplatky karet k účtu (".mysqli_result($cena_d, $radek, 'pocet_karet').")'>";
...
//$balicek_vzor = $balicek = "<span class='help'>Balíček: ".mysqli_result($vzor, 0, 'cena_trans_bal').", typ ".mysqli_result($vzor, 0, 'cena_trans_bal_typ')."</span><BR>";
//$balicekTyp = mysqli_result($vzor, 0, 24);
